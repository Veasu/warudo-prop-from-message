...
namespace veasu.chathrow {
  [PluginType(Id = "com.veasu.chatfromstringplugin", 
  Name = "Rainbow Node", 
  Description = "Small node to find props based off of message string", 
  Author = "Veasu", 
  Version = "0.1.0", 
  ...
  NodeTypes = new System.Type[] {typeof (GetPropFromStringNode)})]
  public class PropFromStringPlugin : Plugin
  {
  }
